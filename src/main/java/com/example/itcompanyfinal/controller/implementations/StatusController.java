...
public class StatusController implements ReadController<Status> {
    private final ReadService<Status> SERVICE;

    public StatusController(ReadService<Status> SERVICE) {
    ...
    @Override
    @GetMapping("/{id}")
    public Status showById(@PathVariable int id) throws EmptyResultDataAccessException {
